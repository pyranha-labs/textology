...
"""More advanced example of set up and loop for observer application using Dash compatibility layer."""

from textual.containers import Horizontal
from textual.containers import Vertical
from textual.widget import Widget

from textology.dash_compat import DashCompatApp
from textology.dash_compat import Input
from textology.dash_compat import Output
...
@app.callback(  # Equivalent to "when()".
    Input("main-menu", "highlighted"),  # Equivalent to "Modified".
    Output("content", "children"),  # Equivalent to "Update".
)
